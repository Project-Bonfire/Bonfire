...
if '-o' in sys.argv[1:]:
    ...
    file_path = file_name + '_' + str(network_dime_x) + \
        "x" + str(network_dime_y) + '.vhd'
...
for i in range(network_dime_x * network_dime_y):
    if vc:
        string_to_print += "\tRX_L_" + str(i) + ", credit_out_L_" + \
                              str(i) + ", valid_out_L_" + str(i) + ", credit_in_L_" + \
                              str(i) + ", valid_in_L_" + str(i) + ", credit_out_vc_L_" + \
                              str(i) + ", valid_out_vc_L_" + str(i) + ", credit_in_vc_L_" + \
                              str(i) + ", valid_in_vc_L_" + str(i) + ",  TX_L_" + str(i) + ", \n"
    else:
        string_to_print += "\tRX_L_" + str(i) + ", credit_out_L_" + \
                              str(i) + ", valid_out_L_" + str(i) + ", credit_in_L_" + \
                              str(i) + ", valid_in_L_" + str(i) + ",  TX_L_" + str(i) + ", \n"
